...
def extract_imu_data_with_global_time(pb3_path, output_csv_path=None):
    ...
    # 打印给用户确认
    real_world_start = datetime.datetime.fromtimestamp(
        start_time_sec + start_time_nanos / 1e9
    )
    print(
...
if __name__ == "__main__":
    ...
    PB3_FILE = "/home/hao/shared_files/dataset/lab_0630_phone/video_meta.pb3"
